...
public class CollectionsListDataSource extends PageKeyedDataSource<Integer, Media> {

    private final String genreId;

    private final SettingsManager settingsManager;

    public CollectionsListDataSource(String genreId, SettingsManager settingsManager){
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = apiInterface.getCollectionById(genreId,FIRST_PAGE);
    ...
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, Media> callback) {
        ...
        ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
        Call<GenresData> call = apiInterface.getCollectionById(genreId,params.key);
        call.enqueue(new Callback<>() {
