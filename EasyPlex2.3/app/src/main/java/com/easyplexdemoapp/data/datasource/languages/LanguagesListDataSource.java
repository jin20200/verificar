...
public class LanguagesListDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    public LanguagesListDataSource(String genreId, SettingsManager settingsManager){
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Media> callback) {
        ...
        if (length>2){
            ...
            call = apiInterface.getLanguagesByName(genreId,settingsManager.getSettings().getApiKey(),FIRST_PAGE);
        }else {

            call = apiInterface.getLanguagesByID(genreId,settingsManager.getSettings().getApiKey(),FIRST_PAGE);
        }
    ...
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, Media> callback) {
        ...
        if (length>2){
            ...
            call = apiInterface.getLanguagesByName(genreId,settingsManager.getSettings().getApiKey(),params.key);
        }else {

            call = apiInterface.getLanguagesByID(genreId,settingsManager.getSettings().getApiKey(),params.key);
        }
