...
import com.easyplexdemoapp.databinding.RowSeasons2Binding;
...
public class EpisodeAnimeAdapter extends PagedListAdapter<Episode, EpisodeAnimeAdapter.NextPlayMoviesViewHolder> {
    ...
    public EpisodeAnimeAdapter(String serieid, String seasonsid, String seasonsidpostion, String currentseason, SharedPreferences preferences, AuthManager authManager
       ...
       premuim, TokenManager tokenManager, Context context, String serieCover, Media media, String mediaGenre, String externalId, int animationType,DeviceManager deviceManager) {
        super(ITEM_CALLBACK);
    ...
    class NextPlayMoviesViewHolder extends RecyclerView.ViewHolder {
        ...
        private boolean episodeMiniMenuClicked(MenuItem item, Episode episode, int position) {
            ...
            if (itemId == R.id.play_menu) {
                ...
                if (tokenManager.getToken().getAccessToken() != null) {
                    ...
                    Toast.makeText(context, context.getString(R.string.login_to_comment), Toast.LENGTH_SHORT).show();
                }
            }
            return true;
        }
                ...
                builder.setItems(charSequence, (dialogInterface, wich) -> {
                    ...
                    if (episode.getVideos().get(wich).getEmbed() == 1) {
                        ...
                        if (castSession != null && castSession.isConnected()) {
                            ...
                            onLoadExternalPlayers(episode, position,episode.getVideos().get(wich).getLink());
                ...
                if (episode.getVideos().get(0).getEmbed() == 1) {
                            ...
                            if (multipleQuality) {
                                    ...
                                    builder.setItems(name, (dialogInterface, i) -> {
                                        ...
                                        if (castSession != null && castSession.isConnected()) {
                                            ...
                                            if (settingsManager.getSettings().getVlc() == 1) {
                                                ...
                                                onLoadExternalPlayers(episode, position,vidURL.get(i).getUrl());
                                ...
                                if (castSession != null && castSession.isConnected()) {
                                    ...
                                    if (settingsManager.getSettings().getVlc() == 1) {
                                        ...
                                        onLoadExternalPlayers(episode, position,vidURL.get(0).getUrl());
                    ...
                    if (castSession != null && castSession.isConnected()) {
                        ...
                        if (settingsManager.getSettings().getVlc() == 1) {
                            ...
                            onLoadExternalPlayers(episode, position,episode.getVideos().get(0).getLink());
        ...
        private void onLoadExternalPlayers(Episode episode, int position , String link) {
            ...
            vlc.setOnClickListener(v12 -> {
                Tools.streamEpisodeFromVlc(context, link, episode,settingsManager);
                dialog.hide();
            });

            mxPlayer.setOnClickListener(v12 -> {
                Tools.streamEpisodeFromMxPlayer(context, link, episode,settingsManager);
                dialog.hide();
            ...
            webcast.setOnClickListener(v12 -> {
                ...
                Tools.streamEpisodeFromMxWebcast(context, link, episode,settingsManager);
                dialog.hide();
            ...
            easyplexPlayer.setOnClickListener(v12 -> {
                onLoadMainPlayerStream(episode, position, link, episode.getVideos().get(0));
                dialog.hide();
            });
        ...
        private void onLoadMainPlayerStream(Episode episode, int position, String url, EpisodeStream episodeStream) {
          ...
          HistorySaver.onMEpisodeSave(episode,media,authManager,mediaRepository,mediaGenre,currentSeasons,tvseasonid,currentSeasonsNumber,"anime",deviceManager, settingsManager);
