...
import com.easyplexdemoapp.databinding.ActivityBrowserBookmarksBinding;
    ...
    implements BrowserBookmarksAdapter.ClickListener
{
    ...
    {
        if (menuId == R.id.edit_bookmark_menu) {
            showEditDialog(item);
        } else if (menuId == R.id.delete_bookmark_menu) {
            delete(Collections.singletonList(item));
        } else if (menuId == R.id.share_bookmark_menu) {
            shareBookmark(item);
        }
    }
    ...
    private final ActionMode.Callback actionModeCallback = new ActionMode.Callback()
    {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item)
        {
            ...
            if (itemId == R.id.edit_bookmark_menu) {
                ...
                mode.finish();
            } else if (itemId == R.id.delete_bookmark_menu) {
