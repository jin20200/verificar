 ...
 * @author Yobex.
 */
public class CustomGenreAdapter extends RecyclerView.Adapter<CustomGenreAdapter.MainViewHolder> {
    ...
    @NonNull
    @Override
    public CustomGenreAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CustomGenreAdapter.MainViewHolder(binding);
    }
