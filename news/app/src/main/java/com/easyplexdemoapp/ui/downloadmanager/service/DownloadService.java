...
import com.easyplexdemoapp.ui.downloadmanager.core.model.DownloadEngineListener;
...
public class DownloadService extends Service
{
    ...
    private void makeForegroundNotify()
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
            startForeground(FOREGROUND_NOTIFICATION_ID, foregroundNotify.build(),FOREGROUND_SERVICE_TYPE_DATA_SYNC);
        }else {
