 ...
 * @author Yobex.
 */
public class CustomNetworkAdapter extends RecyclerView.Adapter<CustomNetworkAdapter.MainViewHolder> {
    ...
    public CustomNetworkAdapter(SettingsManager settingsManager, AppController appController) {
    ...
    @NonNull
    @Override
    public CustomNetworkAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CustomNetworkAdapter.MainViewHolder(binding);
