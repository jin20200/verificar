    ...
    class NextPlayMoviesViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(Media media) {
            ...
            binding.rootLayout.setOnClickListener(v -> {
                ...
                mediaRepository.getSerie(media.getId())
        ...
        if (settingsManager.getSettings().getServerDialogSelection() == 1) {
            ...
            for (int i = 0; i<media.getSeasons().get(0).getEpisodes().get(0).getVideos().size(); i++) {
                ...
                if (settingsManager.getSettings().getEnablelangsinservers() == 1){
                    ...
                    charSequence[i] = media.getSeasons().get(0).getEpisodes().get(0)
                            .getVideos().get(i).getServer() + " - " + media.getSeasons().get(0).getEpisodes().get(0).getVideos().get(i).getLang();

                }else {

                    charSequence[i] = media.getSeasons().get(0).getEpisodes().get(0)
                            .getVideos().get(i).getServer();
                }
